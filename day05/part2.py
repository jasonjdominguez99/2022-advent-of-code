...
# Python solution for part 2 of day 5 of 
# 2022 'Advent of Code'
#
# This code outputs the letters of the crates
# at the top of the stacks after rearranging
# with the given instructions, with the ability
# to move multiple crates at once
...
def main():
    ...
    for ins in instructions:
        to_move = stacks[ins["from"]][-ins["move"]:]
        stacks[ins["from"]] = stacks[ins["from"]][:-ins["move"]]
        stacks[ins["to"]] += to_move
